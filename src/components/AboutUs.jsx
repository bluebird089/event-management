    ...
    return (
        <div className="bg-green-950 bg-opacity-10 py-10 md:py-20">
            <div className="container px-3 sm:px-0 mx-auto flex flex-col md:flex-row md:items-center gap-5">
                <div className="md:w-1/3 space-y-1 md:space-y-6">
                    {/* Title Section */}
                    <div>
                ...
                <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div className="flex flex-col justify-center items-center gap-3 py-5 md:py-10 bg-white rounded-md hover:bg-green-950 hover:text-white duration-300">
                    ...
                    <div className="flex flex-col justify-center items-center gap-3 py-3 md:py-10 bg-white rounded-md hover:bg-green-950 hover:text-white duration-300">
